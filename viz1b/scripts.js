...
d3.csv('disasters.csv')
  ...
  for(let i = 0; i<data.length; i++){
  	...
  	let radius = mapFromDomainToRange(1, 160, 3, 20, cost); //******* don't use 10, use mapFromDomainToRange.  The max cost is 160, and the min cost is 1
...
// hehe-siju is trying to create this function changes the colors of all circles to random colors
